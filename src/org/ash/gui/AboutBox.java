...
public class AboutBox extends JDialog implements ActionListener {
  ...
  private void init() {
	  ...
	  other.append("\n"+"JFreeChart"+"\n");
	  other.append(Options.getInstance().getResource("version")+" "+" 1.0.24"+"\n");
	  ...
	  other.append(Options.getInstance().getResource("version")+" "+" 1.0"+"\n");
	  other.append(" http://swinglabs.java.sun.com"+"\n");
	  other.append("\n"+"Joda Time - Java date and time API"+"\n");
	  other.append(Options.getInstance().getResource("version")+" "+" 2.9.9"+"\n");
